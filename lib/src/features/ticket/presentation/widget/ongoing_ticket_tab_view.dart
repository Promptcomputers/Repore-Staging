...
class OnGoingTicketTabView extends ConsumerStatefulWidget {
  const OnGoingTicketTabView({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _OnGoingTicketTabViewState();
}

class _OnGoingTicketTabViewState extends ConsumerState<OnGoingTicketTabView> {
  @override
  Widget build(BuildContext context) {
    ...
    final onGoingList = vm.isLoading
        ...
        : vm.asData?.value.data!
            .where((element) => element.status == TicketStatusType.ONGOING.name)
            .toList();
    return Container(
