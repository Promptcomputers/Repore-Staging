...
class CompletedTicketTabView extends ConsumerStatefulWidget {
  const CompletedTicketTabView({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _CompletedTicketTabViewState();
}

class _CompletedTicketTabViewState
    extends ConsumerState<CompletedTicketTabView> {
  @override
  Widget build(BuildContext context) {
    ...
    final onGoingList = vm.isLoading
        ...
        : vm.asData?.value.data!
            .where((element) => element.status == TicketStatusType.CLOSED.name)
            .toList();
    return Container(
